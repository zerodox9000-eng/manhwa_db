...
- AniList enrichment uses 100-title primary batches, the maximum accepted by the current query-complexity ceiling. Keep smaller adaptive fallbacks for malformed or newly missing IDs; do not raise the primary batch without measuring the live API again.
