...
- `curation/tag-overrides.json` is a reviewed registry of narrowly scoped tag removals applied during normalization. It corrects confirmed source misclassifications without changing raw MangaBaka data, and daily normalization reapplies it.
